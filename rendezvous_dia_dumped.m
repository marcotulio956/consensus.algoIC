...
% Define Dynamics : D integrator with dumping
...
Laplacian1=kron(Laplacian, [0.1 0; 1 0])% x and x' in X for all agents
Laplacian1(1:2:end,2:2:end)=eye(nAgents)
Laplacian1(1:nOrder,:)=0 % no dyns 4 leader
...
sgtitle('Rendezvous with Helical Leader, Double Integrator')